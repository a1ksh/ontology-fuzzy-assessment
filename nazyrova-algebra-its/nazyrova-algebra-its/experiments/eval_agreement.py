"""Reproduce: Table 5 (Cohen's kappa, RMSE, gap localisation).

Loads config/config.yaml + data/, runs the model and baselines under the
cross-validation split, writes results to results/eval_agreement.csv.
...
def main():
    ...
    raise NotImplementedError("Wire to data + src; write results/eval_agreement.csv.")
